...
<div class="container mb-5 mt-4 pt-5">
    <div class="row">
        <div>
            <h2 class="text-color-theme">About ANP</h2><br>
            <p>
        ...
        <div>
            <h4 class="text-color-secondary">OBJECTIVES:</h4>
            <br>
            <ul>
                <li>Represent, promote and lobby the interest of micro-small to medium scale producers in Negros</li>
                <li>Encourage cooperation among our producers and key players in various industries in the community</li>
                <li>Promote the best of Negros products' and our local artisans</li>
                <li>Promote the culture of productivity and technological upgrading of the manufacturing sector in Negros</li>
            </ul>
        <br><br>
        </div>
        ...
        <div>
            ...
            <h4 class="text-color-secondary">MISSION:</h4><br>
            <p>

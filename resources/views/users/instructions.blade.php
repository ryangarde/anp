        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body" style="padding: 3%;">
                    ...
                    <br>
                    <div>
                        <h6 style="font-size: 15px">TERMS AND CONDITIONS</h6>
                        <br>
                    ...
                    <div class="form-check">
                        ...
                        <input type="submit" class="btn anp-btn" id="sendNewSms" value="Proceed" disabled="disabled" onclick="window.location='/shop';">
                    </div>
